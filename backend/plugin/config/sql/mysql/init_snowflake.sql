...
(2069061886627938312, 'Password lockout duration (seconds)', 'USER_SECURITY', 'USER_LOCK_SECONDS', '300', false, null, now(), null),
...
(2069061886627938314, 'Password expiration reminder (days)', 'USER_SECURITY', 'USER_PASSWORD_REMINDER_DAYS', '7', false, '0 disables reminders', now(), null),
...
(2069061886627938318, 'Password must contain a special character', 'USER_SECURITY', 'USER_PASSWORD_REQUIRE_SPECIAL_CHAR', 'false', false, null, now(), null),
