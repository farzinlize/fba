...
@router.get(
    '/callback',
    summary='Automatic Google authorization redirect',
    description=(
        'After Google authorization, redirect here to fetch user information and automatically create a system user'
    ),
