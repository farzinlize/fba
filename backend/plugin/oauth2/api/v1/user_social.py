...
@router.get('/me/bindings', summary='Get linked social accounts for the user', dependencies=[DependsJwtAuth])
...
@router.get('/me/binding', summary='Get account linking authorization URL', dependencies=[DependsJwtAuth])
...
@router.delete('/me/unbinding', summary='Unlink user social account', dependencies=[DependsJwtAuth])
