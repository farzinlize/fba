...
values
(2048601263901376512, 'Current department data access', 1, now(), null),
(2048601263968485376, 'Department and descendant data access', 1, now(), null),
(2048601263968485377, 'Own data only', 1, now(), null),
(2048601263968485378, 'Current department data access across all models', 1, now(), null),
(2048601263968485379, 'Exclude superuser data', 1, now(), null);
...
(2048601264102703105, 'Parent department ID equals the test department ID', 'Dept', 'parent_id', 0, 0, '1', now(), null),
(2048601264102703106, 'Creator equals the current user', '__ALL__', '__created_by__', 0, 0, '${user_id}', now(), null),
(2048601264102703107, 'Department ID equals the current user department across all models', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2048601264102703109, 'User is not a superuser', 'User', 'is_superuser', 0, 1, '1', now(), null);
