...
(14, 'Edit role menus', 'EditSysRoleMenu', null, 0, null, 2, null, 'sys:role:menu:edit', 1, 0, 1, '', null, 11, '2025-06-26 20:29:06', null),
(15, 'Edit role data scopes', 'EditSysRoleScope', null, 0, null, 2, null, 'sys:role:scope:edit', 1, 0, 1, '', null, 11, '2025-06-26 20:29:06', null),
...
(25, 'Edit data scope rules', 'EditDataScopeRule', null, 0, null, 2, null, 'data:scope:rule:edit', 1, 0, 1, '', null, 22, '2025-06-26 20:29:06', null),
...
(47, 'Documentation', 'Document', '/fba/document', 1, 'lucide:book-open-text', 4, '/_core/fallback/iframe.vue', null, 1, 1, 1, 'https://fastapi-practices.github.io/fastapi_best_architecture_docs', null, 46, '2025-06-26 20:29:06', null),
...
values
(1, 'Current department data access', 1, now(), null),
(2, 'Test department and descendant data access', 1, now(), null),
(3, 'Own data only', 1, now(), null),
(4, 'Current department data access across all models', 1, now(), null),
(5, 'Exclude superuser data', 1, now(), null);

insert into sys_data_rule (id, name, model, "column", operator, expression, "value", created_time, updated_time)
values
(1, 'Department ID equals the current user department', 'Dept', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2, 'Department name equals Test', 'Dept', 'name', 1, 0, 'Test', now(), null),
(3, 'Parent department ID equals the test department ID', 'Dept', 'parent_id', 0, 0, '1', now(), null),
(4, 'Creator equals the current user', '__ALL__', '__created_by__', 0, 0, '${user_id}', now(), null),
(5, 'Department ID equals the current user department across all models', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(6, 'User is not a superuser', 'User', 'is_superuser', 0, 1, '1', now(), null);
