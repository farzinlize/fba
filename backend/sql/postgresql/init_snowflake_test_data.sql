...
(2049629108245233677, 'Edit role menus', 'EditSysRoleMenu', null, 0, null, 2, null, 'sys:role:menu:edit', 1, 0, 1, '', null, 2049629108245233674, '2025-06-26 20:29:06', null),
(2049629108245233678, 'Edit role data scopes', 'EditSysRoleScope', null, 0, null, 2, null, 'sys:role:scope:edit', 1, 0, 1, '', null, 2049629108245233674, '2025-06-26 20:29:06', null),
...
(2049629108249427973, 'Edit data scope rules', 'EditDataScopeRule', null, 0, null, 2, null, 'data:scope:rule:edit', 1, 0, 1, '', null, 2049629108249427970, '2025-06-26 20:29:06', null),
...
(2049629108253622279, 'Documentation', 'Document', '/fba/document', 1, 'lucide:book-open-text', 4, '/_core/fallback/iframe.vue', null, 1, 1, 1, 'https://fastapi-practices.github.io/fastapi_best_architecture_docs', null, 2049629108253622278, '2025-06-26 20:29:06', null),
...
values
(2048601269806956544, 'Current department data access', 1, now(), null),
(2048601269869871104, 'Department and descendant data access', 1, now(), null),
(2048601269869871105, 'Own data only', 1, now(), null),
(2048601269869871106, 'Current department data access across all models', 1, now(), null),
(2048601269869871107, 'Exclude superuser data', 1, now(), null);
...
(2048601269999894529, 'Parent department ID equals the test department ID', 'Dept', 'parent_id', 0, 0, '1', now(), null),
(2048601269999894530, 'Creator equals the current user', '__ALL__', '__created_by__', 0, 0, '${user_id}', now(), null),
(2048601269999894531, 'Department ID equals the current user department across all models', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2048601269999894533, 'User is not a superuser', 'User', 'is_superuser', 0, 1, '1', now(), null);
